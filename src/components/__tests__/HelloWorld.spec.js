...
vi.mock('@/services/api.js', () => ({ /* simule le module api.js, ce qui évite les vrais appels HTTP */
    api: {
        getHello: vi.fn()
    }
}))
...
describe('HelloWorld', () => {
    it('renders properly', async () => {
        ...
        const wrapper = mount(HelloWorld) /* monte le composant HelloWorld.vue pour le tester seul */
